...
### Stage 
> [!TIP]
> 1. Those stages are likely to be sequential, although some tasks might require some iterations.
> 2. You can create subtasks if intermediate steps in the sequence below entail other subtasks.
> 3. Remember to update this task's status accordingly.

- [ ] :one: Github task setup:
